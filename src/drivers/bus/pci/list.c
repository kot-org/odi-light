pci_device_list_info_t* pci_list_init(void){
    pci_device_list_info_t* return_value = (pci_device_list_info_t*)odi_dep_malloc(sizeof(pci_device_list_info_t));
...
void convert_list_to_array(pci_device_list_info_t* devices_list, pci_device_array_info_t* devices_array){
    ...
    devices_array->devices = (pci_device_t**)odi_dep_malloc((devices_list->devices->length + 1) * sizeof(pci_device_t*));
